...
class Vista_lista_carreras(QWidget):
    ...
    def terminar_carrera(self, id_carrera):
        ...
        """
        # Se agrega esta liena
        self.id_carr = self.carreras[id_carrera]
        self.interfaz.carrera_actual = self.id_carr['id']
        dialogo = Dialogo_terminar_carrera(self.interfaz.dar_competidores())
        dialogo.exec_()
        if dialogo.resultado == 1:
            self.hide()
            self.interfaz.mostrar_reporte_ganancias(dialogo.combobox_competidores.currentText())            
...
# Un pequeño cambio - OJO
    ...
    def eliminar_carrera(self,indice_carrera): 
        ...
        """
        self.id_carr = self.carreras[indice_carrera] 
        ...
        if respuesta == QMessageBox.Yes:
             self.interfaz.eliminar_carrera(self.id_carr)
