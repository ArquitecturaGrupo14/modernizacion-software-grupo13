...
class App_EPorra(QApplication):
    ...
    def editar_apuesta(self, apostador_actual,competidor_actual,valor_nuevo,apostador_nuevo,competidor_nuevo,nombre_carrera):
        
        id_carrera = self.logica.dar_id_carrera(nombre_carrera)
        
        self.logica.editar_apuesta(apostador_actual,competidor_actual,valor_nuevo,apostador_nuevo,competidor_nuevo,id_carrera)
        self.vista_lista_apuestas=Vista_lista_apuestas(self)
        self.vista_lista_apuestas.mostrar_apuestas(nombre_carrera, self.logica.dar_apuestas_carrera(id_carrera))
    ...
    def aniadir_competidor(self, nombre, probabilidad,nombre_carrera):
        """
        Esta función inserta un nuevo competidor en una carrera
        """
        
        self.logica.aniadir_competidor(self.carrera_actual, nombre, probabilidad,nombre_carrera)

        # OBSERVACION: Validar codigo original, en la linea anterior se agrega parametro nombre_carrera
        #nombre_carrera2 = self.logica.dar_carrera(-1)
        #self.vista_carrera.mostrar_competidores(nombre_carrera2, self.logica.dar_competidores_carrera(nombre_carrera)) 
